...
ViRHaS::ViRHaS(MR001004 & m1m2, MR001004 & m3, Encoder & e1, Encoder & e2, Encoder & e3)
: _m1m2(m1m2), _m3(m3), _e1(e1),_e2(e2),_e3(e3) {
  _m1m2.init2M();
  _m1m2.setM1Speed(0);
  _m1m2.setM2Speed(0);
  _m3.init1M();
...
void ViRHaS::PIDLoop(){
	...
	if(deltaPid >= LOOPTIME)   {// enter tmed loop
	   ...
	   _m1m2.setM1Speed(PWM_val[0]);
	   _m1m2.setM2Speed(PWM_val[1]);
	   _m3.setM1Speed(PWM_val[2]);
